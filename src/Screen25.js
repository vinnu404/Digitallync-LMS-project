    ...
    return (
        <div class="h-screen w-screen">
           <div class="float-left">
            ...
            <p class="ml-48 relative bottom-2 text-gray-500">Your Upcoming Class at 28-04-20 IST 5:30pm</p>
            ...
            <div class="border border-gray-300 ml-20 mt-6" style={{width:500,height:40}}>
                <BsSquare class="mt-2 ml-4" color="gray" size={20}/>
            ...
            <div class="border border-gray-300 ml-20 mt-4" style={{width:500,height:40}}>
                <BsCheckSquareFill class="mt-2 ml-4" color="blue" size={20}/>
            ...
            <p class="ml-20 mt-14 text-gray-500" style={{marginLeft:850}}>Skip Question</p>
            <button class="font-bold  w-40 p-2 bg-blue-500 text-white relative bottom-8" style={{marginLeft:1000}}>Check Answers</button>
